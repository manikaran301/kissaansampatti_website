          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-7 lg:gap-8 mb-6 sm:mb-8">
            ...
            <div className="sm:col-span-2">
              ...
              <div className="flex gap-2 sm:gap-2.5">
                {/* Facebook */}
                <a href="https://www.facebook.com/profile.php?id=61584668245437" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-8 sm:w-9 lg:w-10 h-8 sm:h-9 lg:h-10 rounded-lg bg-white border border-[var(--border)] hover:border-[var(--brand)] hover:bg-[var(--brand-light)] transition-all duration-200 group">
                ...
                {/* Instagram */}
                <a href="https://www.instagram.com/kissaan.sampatti/" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-8 sm:w-9 lg:w-10 h-8 sm:h-9 lg:h-10 rounded-lg bg-white border border-[var(--border)] hover:border-[var(--brand)] hover:bg-[var(--brand-light)] transition-all duration-200 group">
                  <svg className="w-4 sm:w-4.5 lg:w-5 h-4 sm:h-4.5 lg:h-5 text-[var(--text-secondary)] group-hover:text-[var(--brand)]" fill="currentColor" viewBox="0 0 24 24">
                ...
                {/* YouTube */}
                <a href="https://www.youtube.com/@kissaansampattiapp" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-8 sm:w-9 lg:w-10 h-8 sm:h-9 lg:h-10 rounded-lg bg-white border border-[var(--border)] hover:border-[var(--brand)] hover:bg-[var(--brand-light)] transition-all duration-200 group">
                  <svg className="w-4 sm:w-4.5 lg:w-5 h-4 sm:h-4.5 lg:h-5 text-[var(--text-secondary)] group-hover:text-[var(--brand)]" fill="currentColor" viewBox="0 0 24 24">
